...
import uz.uzinfocom.app.modules.report.form12.application.export.Form12ByTerritoryExcelExportSource;
import uz.uzinfocom.app.modules.report.form12.application.export.Form12ByTerritoryExportFilter;
...
public class Form12ByTerritoryReportController {
    ...
    @Operation(
            summary = "Экспорт Form 12 (по территориям) в Excel",
    ...
    @PostMapping(ApiPaths.Form12Report.BY_TERRITORY_EXPORT)
    @PreAuthorize("isAuthenticated() and hasAuthority('PERMISSION_REPORTS_READ')")
    public ApiResponse<ExportJobResponse> export(
        ...
        return ApiResponse.success(
                ...
                exportJobService.submit(form12ByTerritoryExcelExportSource, new Form12ByTerritoryExportFilter(from, to))
        );
    }
}
