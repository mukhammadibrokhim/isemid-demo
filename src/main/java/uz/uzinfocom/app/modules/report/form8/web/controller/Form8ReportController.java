 ...
 * составу», сравнительный анализ: только подтверждённые ({@code status =
 * 'APPROVED'}) извещения, форма №058 и №058-1 объединены, за
...
@Tag(
        ...
        description = "API отчёта «Form 8: инфекционные и паразитарные заболевания по социальному составу» "
                + "(формы №058 + №058-1, объединённые), только подтверждённые (status = APPROVED) извещения, за выбранный период в сравнении "
