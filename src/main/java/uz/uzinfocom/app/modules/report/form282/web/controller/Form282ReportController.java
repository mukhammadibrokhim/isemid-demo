...
import uz.uzinfocom.app.modules.report.form282.application.export.Form282ExcelExportSource;
import uz.uzinfocom.app.modules.report.form282.application.export.Form282ExportFilter;
...
public class Form282ReportController {
    ...
    private final Form282ExcelExportSource form282ExcelExportSource;
    ...
    @Operation(
            summary = "Экспорт Form 28.2 в Excel",
    ...
    @PostMapping(ApiPaths.Form282Report.EXPORT)
    @PreAuthorize("isAuthenticated() and hasAuthority('PERMISSION_REPORTS_READ')")
    public ApiResponse<ExportJobResponse> export(
        ...
        return ApiResponse.success(
                ...
                exportJobService.submit(form282ExcelExportSource, new Form282ExportFilter(from, to))
        );
    }
}
