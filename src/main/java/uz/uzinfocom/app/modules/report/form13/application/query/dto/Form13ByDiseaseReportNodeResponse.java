...
@Schema(description = "Одна строка отчёта «Form 13 (по нозологическим формам)». На корневом уровне — одна "
        + "нозологическая форма (запись справочника ручных отчётов с типом FORM_13); при раскрытии строки — "
        + "один узел географии (регион/район/организация) для этой же нозологической формы. Три метрики "
        + "(всего / до 14 лет / до 18 лет), каждая за выбранный период рядом с тем же периодом год назад "
        + "и разницей.")
public record Form13ByDiseaseReportNodeResponse(
