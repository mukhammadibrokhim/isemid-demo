...
@Schema(description = "Analitik hisobotni yaratish uchun ma'lumotlar. content — muharrirda avtomatik " +
        "to'ldirilgan (compute javobidan) va so'ng qo'lda tahrirlangan matn, sifatida qabul qilinadi.")
public record AnalyticReportCreateRequest(
        @Schema(description = "Hisobot nomi (odatda davr+hudud+tashxisdan avtomatik tuziladi, keyin tahrirlanadi).",
