...
@Schema(description = "Одна ячейка-болезнь в строке отчёта «Form 12 (по территориям)»: подтверждённые "
        ...
        + "ручных отчётов с тегом FORM_12) в данном узле географии — за выбранный период (\"Joriy yil\") и за "
        + "тот же период год назад (\"O'tgan yil\"), каждый в трёх метриках: всего / до 14 лет / до 18 лет.")
