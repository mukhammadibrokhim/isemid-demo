...
import uz.uzinfocom.app.modules.report.form4.application.export.Form4ExcelExportSource;
import uz.uzinfocom.app.modules.report.form4.application.export.Form4ExportFilter;
...
public class Form4ReportController {
    ...
    private final Form4ExcelExportSource form4ExcelExportSource;
    ...
    @Operation(
            summary = "Экспорт Form 4 в Excel",
    ...
    @PostMapping(ApiPaths.Form4Report.EXPORT)
    @PreAuthorize("isAuthenticated() and hasAuthority('PERMISSION_REPORTS_READ')")
    public ApiResponse<ExportJobResponse> export(
        ...
        return ApiResponse.success(
                ...
                exportJobService.submit(form4ExcelExportSource, new Form4ExportFilter(from, to, diagnosisCode))
        );
    }
}
