...
@Schema(description = "Данные для создания ручной записи Shakl №7. Блок registered* и "
        + "primaryDiagnosisConfirmed в запросе не передаются — сервер вычисляет их самостоятельно "
        + "по from/to и создающей организации.")
public record Form7EntryCreateRequest(
