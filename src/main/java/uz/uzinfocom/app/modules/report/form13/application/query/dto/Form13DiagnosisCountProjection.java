 ...
 * single confirmed-diagnosis code ({@code coalesce(final_icd10_code,
 * icd10_code)}), across the caller's whole access scope (no organization
 * attribution). {@code Form13GeographyCountSource} rolls these per-code rows up
