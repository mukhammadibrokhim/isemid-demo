...
import uz.uzinfocom.app.modules.report.form281.application.export.Form281ExcelExportSource;
import uz.uzinfocom.app.modules.report.form281.application.export.Form281ExportFilter;
...
public class Form281ReportController {
    ...
    private final Form281ExcelExportSource form281ExcelExportSource;
    ...
    @Operation(
            summary = "Экспорт Form 28.1 в Excel",
    ...
    @PostMapping(ApiPaths.Form281Report.EXPORT)
    @PreAuthorize("isAuthenticated() and hasAuthority('PERMISSION_REPORTS_READ')")
    public ApiResponse<ExportJobResponse> export(
        ...
        return ApiResponse.success(
                ...
                exportJobService.submit(form281ExcelExportSource, new Form281ExportFilter(from, to))
        );
    }
}
