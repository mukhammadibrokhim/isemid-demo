...
import uz.uzinfocom.app.modules.report.form281.application.export.Form281ByTerritoryExcelExportSource;
import uz.uzinfocom.app.modules.report.form281.application.export.Form281ByTerritoryExportFilter;
...
public class Form281ByTerritoryReportController {
    ...
    private final Form281ByTerritoryExcelExportSource form281ByTerritoryExcelExportSource;
    ...
    @Operation(
            summary = "Экспорт Form 28.1 (по территориям) в Excel",
    ...
    @PostMapping(ApiPaths.Form281Report.BY_TERRITORY_EXPORT)
    @PreAuthorize("isAuthenticated() and hasAuthority('PERMISSION_REPORTS_READ')")
    public ApiResponse<ExportJobResponse> export(
        ...
        return ApiResponse.success(
                ...
                exportJobService.submit(form281ByTerritoryExcelExportSource, new Form281ByTerritoryExportFilter(from, to))
        );
    }
}
