...
import uz.uzinfocom.app.modules.iam.application.shared.dto.MedicalTypeCountProjection;
import uz.uzinfocom.app.modules.iam.application.shared.dto.OrganizationGeoProjection;
import uz.uzinfocom.app.modules.iam.application.shared.dto.OrganizationLevelCountProjection;
...
public interface OrganizationRepository extends JpaRepository<Organization, Long>, JpaSpecificationExecutor<Organization> {
    ...
    @Query("""
                SELECT new uz.uzinfocom.app.modules.iam.application.shared.dto.OrganizationLocalizedName(
     ...
     */
    @Query("""
            select new uz.uzinfocom.app.modules.iam.application.shared.dto.MedicalTypeCountProjection(o.medicalType, count(o))
            from Organization o
            where o.active = true
              and (:regionCode is null or o.regionCode = :regionCode)
              and (:districtCode is null or o.districtCode = :districtCode)
    ...
    @Query("""
            select new uz.uzinfocom.app.modules.iam.application.shared.dto.OrganizationLevelCountProjection(o.levelType, count(o))
            from Organization o
            where o.active = true
              and (:regionCode is null or o.regionCode = :regionCode)
              and (:districtCode is null or o.districtCode = :districtCode)
    ...
    @Query("""
            select new uz.uzinfocom.app.modules.iam.application.shared.dto.OrganizationGeoProjection(
                o.id, o.districtCode
            )
            from Organization o
            where o.active = true
     ...
     */
    @Query("""
            select new uz.uzinfocom.app.modules.iam.application.shared.dto.OrganizationNameProjection(
