package uz.uzinfocom.app.modules.reference.application.region.query.dto;
...
@Schema(description = "Параметры поиска для справочного выбора регионов.")
public record RegionLookupFilterRequest(
        ...
        @Min(value = 1, message = "{reference.region.filter.limit.min}")
        @Max(value = 200, message = "{reference.region.filter.limit.max}")
        Integer limit,
