package uz.uzinfocom.app.modules.reference.application.region.query.specification;
...
public final class RegionSpecification {
    ...
    public static Specification<Region> byParentCodeAndName(String parentCode, String name) {
        return (root, query, cb) -> {
            List<Predicate> predicates = new ArrayList<>();
