package uz.uzinfocom.app.modules.reference.web.region;
...
import uz.uzinfocom.app.modules.reference.application.region.dto.RegionCreateRequest;
import uz.uzinfocom.app.modules.reference.application.region.query.dto.RegionFilterRequest;
import uz.uzinfocom.app.modules.reference.application.region.query.dto.RegionLookupFilterRequest;
import uz.uzinfocom.app.modules.reference.application.region.query.dto.RegionLookupResponse;
import uz.uzinfocom.app.modules.reference.application.region.query.dto.RegionResponse;
import uz.uzinfocom.app.modules.reference.application.region.query.dto.RegionTableResponse;
import uz.uzinfocom.app.modules.reference.application.region.dto.RegionUpdateRequest;
import uz.uzinfocom.app.modules.reference.application.region.command.RegionCommandService;
import uz.uzinfocom.app.modules.reference.application.region.query.RegionQueryService;
...
public class RegionController {
    ...
    @Operation(
            ...
            description = """
                    Возвращает список активных регионов, у которых parentCode совпадает
    ...
    @PreAuthorize("isAuthenticated()")
    public ApiResponse<List<RegionLookupResponse>> getByParentCode(
        ...
        return ApiResponse.success(
                ...
                regionQueryService.getByParentCode(parentCode, request)
        );
    }
