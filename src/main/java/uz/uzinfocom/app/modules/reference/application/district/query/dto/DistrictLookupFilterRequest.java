...
@Schema(description = "Параметры поиска для справочного выбора районов.")
public record DistrictLookupFilterRequest(
        ...
        @Min(value = 1, message = "{reference.district.filter.limit.min}")
        @Max(value = 200, message = "{reference.district.filter.limit.max}")
        Integer limit,
