...
public class Form058Specification {
     ...
     * "what's the latest form058 for this identifier"): visible only if the
     * caller's own organization was sender or receiver on it - the same
     ...
     * <p>
     * Matches on identifier value only, like {@link #visibleByNnuzb} -
     ...
     */
    public Specification<Form058> visibleByDocumentValueAndOrganization(
