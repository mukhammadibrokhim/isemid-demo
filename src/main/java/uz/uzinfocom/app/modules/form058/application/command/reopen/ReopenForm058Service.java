...
public class ReopenForm058Service {

    private final Form058JpaRepository form058JpaRepository;
    private final Form058UpdateMapper form058UpdateMapper;
    private final CurrentUserProvider currentUserProvider;
    private final Form058ReopenValidator form058ReopenValidator;
    private final ApplicationEventPublisher eventPublisher;

    @Transactional
    public UpdateForm058Result reopen(Long formId) {
        Form058 form058 = form058JpaRepository.findActiveByIdForUpdate(formId)
                .orElseThrow(() -> new Form058NotFoundException(formId));
        form058ReopenValidator.validate(form058);
