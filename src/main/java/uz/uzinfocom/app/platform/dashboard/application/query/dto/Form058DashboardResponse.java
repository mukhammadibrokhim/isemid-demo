...
@Schema(description = "Полная статистика только по форме №058 (без формы №058-1), в рамках доступа текущей "
...
public record Form058DashboardResponse(
        ...
        @Schema(description = "Общее количество случаев по форме №058 за всё время.")
        long total,
        ...
        @Schema(description = "Количество карт, прикреплённых к случаям формы №058, с начала текущего "
                + "календарного года.")
        long cardsTotal,

        @Schema(description = "Разбивка карт, привязанных к случаям формы №058, по статусу, с начала текущего "
                + "календарного года.")
        List<CardStatusCountResponse> cardsByStatus,

        @Schema(description = "Количество актов, привязанных к картам случаев формы №058, с начала текущего "
                + "календарного года.")
        long actsTotal,

        @Schema(description = "Разбивка актов, привязанных к картам случаев формы №058, по статусу, с начала "
