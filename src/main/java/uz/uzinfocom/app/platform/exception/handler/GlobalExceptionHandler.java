...
import uz.uzinfocom.app.platform.exception.BaseException;
...
import uz.uzinfocom.app.platform.web.response.FieldViolationResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotSupported(
        ...
        String message = messages.resolve("error.method_not_allowed");
