...
public enum ErrorCode {
    ...
    VALIDATION_FAILED("VALIDATION_FAILED", HttpStatus.BAD_REQUEST, "error.validation"),
    ...
    SCOPE_VIOLATION("SCOPE_VIOLATION", HttpStatus.FORBIDDEN, "error.scope_violation"),
    INTERNAL_ERROR("INTERNAL_ERROR", HttpStatus.INTERNAL_SERVER_ERROR, "error.internal"),
