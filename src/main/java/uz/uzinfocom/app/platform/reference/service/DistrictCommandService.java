...
import uz.uzinfocom.app.platform.reference.dto.DistrictCreateRequest;
import uz.uzinfocom.app.platform.reference.dto.DistrictResponse;
import uz.uzinfocom.app.platform.reference.dto.DistrictUpdateRequest;
...
public class DistrictCommandService {
    ...
    @Transactional
    @Caching(evict = {
            @CacheEvict(cacheNames = ReferenceCacheNames.REF_DISTRICTS, allEntries = true),
            @CacheEvict(cacheNames = ReferenceCacheNames.REF_DISTRICT_BY_CODE, allEntries = true),
            @CacheEvict(cacheNames = ReferenceCacheNames.REF_DISTRICTS_BY_PARENT_CODE, allEntries = true)
    })
