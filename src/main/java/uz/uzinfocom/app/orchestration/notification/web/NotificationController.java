package uz.uzinfocom.app.orchestration.notification.web;
...
import uz.uzinfocom.app.orchestration.notification.application.NotificationCommandService;
import uz.uzinfocom.app.orchestration.notification.application.NotificationQueryService;
import uz.uzinfocom.app.orchestration.notification.application.NotificationStreamService;
...
public class NotificationController {
    ...
    @Operation(
            ...
            description = "Постраничный список уведомлений текущего пользователя, новые сверху. "
                    + "Поддерживает фильтрацию по признаку прочтения, типу уведомления, типу связанной сущности "
                    + "и периоду по дате события."
    )
    @GetMapping
